CREATE DATABASE  IF NOT EXISTS `ejercicio11` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `ejercicio11`;
-- MySQL dump 10.13  Distrib 8.0.31, for Win64 (x86_64)
--
-- Host: localhost    Database: ejercicio11
-- ------------------------------------------------------
...
INSERT INTO `aperturas` VALUES (1,6,'2002-10-03'),(2,7,'2003-09-15'),(3,8,'2005-10-03'),(4,9,'2006-11-07'),(5,10,'2010-12-23'),(6,11,'2014-08-12');
...
INSERT INTO `clientes` VALUES (1,'12345678A','Esteban','C/Chetado'),(2,'12345678B','Victor','C/Mirón'),(3,'12345678C','Javier','C/Manolita'),(4,'12345678D','Saray','C/Esteban'),(5,'12345678E','Lucia','C/San Jorge'),(6,'12345678F','Jaime','C/San Dima');
...
CREATE TABLE `cuentas` (
  ...
  `tipoCuenta` varchar(45) COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
INSERT INTO `cuentas` VALUES (6,'Ahorro',12000.00),(7,'Jubilacion',14000.00),(8,'Ahorro',12543.32),(9,'Jubilacion',4543.65),(10,'Ahorro',56000.42),(11,'Jubilacion',13200.32);
...
-- Dump completed on 2023-01-30 10:39:31
...
-- Dump completed on 2023-01-30 10:39:32
...
CREATE TABLE `ciudades` (
  ...
  `nombreCiudad` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `continentes` (
  ...
  `nombreContinente` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `paises` (
  ...
  `nombrePais` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `asignaturas` (
  ...
  `nombreAsignatura` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `temas` (
  ...
  `descripcionTema` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
CREATE TABLE `ciclos` (
  ...
  `nombreCiclo` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
  PRIMARY KEY (`idCiclo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `persona` WRITE;
/*!40000 ALTER TABLE `persona` DISABLE KEYS */;
INSERT INTO `persona` VALUES (1,'Antonio','Arriba','Fernandez','123456987','antonio@hotmail.es'),(2,'Alberto','Gallardo','Albarran','123456156','alberto@hotmail.es'),(3,'Manuel','Arri','Fernandez','123356987','manuel@hotmail.es'),(4,'Antonio','Montal','Fer','123455987','ant@hotmail.es'),(5,'Esteban','Cod','malo','123456889','esteban@hotmail.es'),(6,'Victor','lamela','caca','122354565','victor@hotmail.es');
/*!40000 ALTER TABLE `persona` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `posesiones` (
  ...
  CONSTRAINT `posesiones_ibfk_1` FOREIGN KEY (`idPersonaFK`) REFERENCES `persona` (`idPersona`),
  CONSTRAINT `posesiones_ibfk_2` FOREIGN KEY (`idVehiculoFK`) REFERENCES `vehiculos` (`idVehiculo`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_spanish2_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
LOCK TABLES `vehiculos` WRITE;
/*!40000 ALTER TABLE `vehiculos` DISABLE KEYS */;
INSERT INTO `vehiculos` VALUES (1,'Kia','Gris','2000-02-12','Deportivo','4758FML','2001-01-15','2022-05-24'),(2,'Ferrari','Rojo','2002-03-14','Deportivo','4358DGL','2003-01-14','2022-01-22'),(3,'feasd','etyhtr','2001-05-05','Familiar','3654RTU','2002-02-20','2022-01-15'),(4,'Citroen','cactus','2002-09-29','Familiar','1849CDR','2003-04-19','2022-05-08'),(5,'Mclaren','Rojo','2002-05-12','Deportivo','8798AML','2003-01-14','2022-01-22'),(6,'Aston Martin','Verde','2002-08-18','Deportivo','1845AST','2003-01-14','2022-01-22');
/*!40000 ALTER TABLE `vehiculos` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
CREATE TABLE `monumentos` (
  ...
  `nombreMonumento` varchar(45) CHARACTER SET utf8mb4 COLLATE utf8mb4_spanish2_ci DEFAULT NULL,
...
INSERT INTO `sys_config` VALUES ('diagnostics.allow_i_s_tables','OFF','2022-12-12 09:28:48',NULL),('diagnostics.include_raw','OFF','2022-12-12 09:28:48',NULL),('ps_thread_trx_info.max_length','65535','2022-12-12 09:28:48',NULL),('statement_performance_analyzer.limit','100','2022-12-12 09:28:48',NULL),('statement_performance_analyzer.view',NULL,'2022-12-12 09:28:48',NULL),('statement_truncate_len','64','2022-12-12 09:28:48',NULL);
...
-- Dump completed on 2023-01-30 10:39:33
